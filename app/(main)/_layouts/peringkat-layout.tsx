...
const generateLeaderboardData = () => {
  const students = [
    { id: 1, name: 'Siti Aminah', class: '2022/2023', xp: 2450, streak: 12, avatar: 'SA' },
    { id: 2, name: 'Dewi Sari', class: '2023/2024', xp: 2380, streak: 10, avatar: 'DS' },
    { id: 3, name: 'Rina Putri', class: '2024/2025', xp: 2320, streak: 15, avatar: 'RP' },
    { id: 4, name: 'Maya Indah', class: '2025/2026', xp: 2180, streak: 8, avatar: 'MI' },
    { id: 5, name: 'Ayu Lestari', class: '2022/2023', xp: 2150, streak: 11, avatar: 'AL' },
    { id: 6, name: 'Fitri Handayani', class: '2023/2024', xp: 2080, streak: 9, avatar: 'FH' },
    { id: 7, name: 'Sari Dewi', class: '2022/2023', xp: 2020, streak: 7, avatar: 'SD' },
    { id: 8, name: 'Nina Kartika', class: '2023/2024', xp: 1980, streak: 13, avatar: 'NK' },
    { id: 9, name: 'Lila Permata', class: '2024/2025', xp: 1920, streak: 6, avatar: 'LP' },
    { id: 10, name: 'Indah Sari', class: '2025/2026', xp: 1850, streak: 14, avatar: 'IS' },
    { id: 11, name: 'Putri Ayu', class: '2022/2023', xp: 1780, streak: 5, avatar: 'PA' },
    { id: 12, name: 'Eka Putri', class: '2023/2024', xp: 1720, streak: 8, avatar: 'EP' },
  ];

  return students.sort((a, b) => b.xp - a.xp);
};

const PeringkatLayout = () => {
  const [selectedClass, setSelectedClass] = useState('Semua Angkatan');

  const leaderboardData = generateLeaderboardData();
  const classes = ['Semua Angkatan', '2022/2023', '2023/2024', '2024/2025', '2025/2026'];
    ...
    <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">Angkatan {student.class}</p>
                      </div>
                    </div>
      ...
      <div className="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl p-6 text-white">
        <div className="flex items-start space-x-3">
          ...
          <div>
            <p className="font-semibold mb-2 text-lg">Sistem Poin XP:</p>
            <ul className="grid grid-cols-1 gap-2">
              <li>• Laporan tepat waktu: +200 XP (berkurang 10 XP per jam)</li>
              <li>• Bonus streak mingguan: +25 XP</li>
              <li>• Bonus streak bulanan: +200 XP</li>
              <li>• Tidak laporan: -50 XP</li>
            </ul>
          </div>
        </div>
      </div>
